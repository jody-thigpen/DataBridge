...
class RoleAndPermissionSeeder extends Seeder
{
    ...
    private array $permissionLabels = [
        ...
        'platform.report_orders.view' => 'View report order queue across clients',
        'platform.report_orders.manage' => 'Assign and review report orders',
        ...
        $definitions = [
            ...
            PlatformRole::Admin->value => [
                ...
                'permissions' => [
                    ...
                    PermissionEnum::PlatformReportOrdersView->value,
                    PermissionEnum::PlatformReportOrdersManage->value,
            ...
            PlatformRole::ClientManager->value => [
                'name' => 'Client Manager',
                'description' => 'Manage assigned clients and review their report orders',
                'sort_order' => 35,
                'permissions' => [
                    PermissionEnum::PlatformReportOrdersView->value,
                    PermissionEnum::PlatformReportOrdersManage->value,
